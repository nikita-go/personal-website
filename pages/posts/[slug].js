...
export default function Post({ frontmatter, content }) {
    return (
        <>
            ...
            <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/katex@0.15.0/dist/katex.min.css" crossOrigin="anonymous"></link>
                        ...
                        <div className="flex flex-row justify-between text-xl">
                            ...
                            <div>
                                {frontmatter.tags.map((tag, tagIndex) => (
                                    ...
                                    {tagIndex!=frontmatter.tags.length-1 && <span className="mx-1 text-[#5187df]">•</span>}
                                    </>
                                ))}
                            </div>
                        </div>
